...
| 6 | [mini-cross-attention](../mini-cross-attention) | Cross-attention module, source↔target alignment |
| 7 | mini-translator _(coming)_ | English→Spanish encoder-decoder with cross-attention |
